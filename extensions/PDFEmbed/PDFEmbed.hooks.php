...
class PDFEmbed {
	...
	static private function embed(File $file, $width, $height, $page) {
		return "<object width='{$width}' height='{$height}' data='".$file->getFullUrl()."' type='application/pdf'>".wfMessage('pdf_not_supported', $file->getFullUrl(), $file->getName())->plain()."<param name='page' value='$page' />"."</object>";
	}
